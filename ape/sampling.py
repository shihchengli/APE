...
is_QM_MM_INTERFACE=None, nHcap=None, QM_USER_CONNECT=None, QM_ATOMS=None, force_field_params=None, fixed_molecule_string=None, opt=None, number_of_fixed_atoms=None):
    ...
    for sample in range(nsample):
        ...
        if e_elec - min_elect > thresh:
            ...
            XyzDictOfEachMode, EnergyDictOfEachMode, ModeDictOfEachMode = sampling_along_vibration(symbols, cart_coords, mode, internal, qk, projected_freq, reduced_mass, rotors_dict, step_size, path, thresh, ncpus, charge, multiplicity, level_of_theory, basis)
            break
